...
#ifndef __INTERFLOP_VECTOR_VERROU_SCALAR_H
#define __INTERFLOP_VECTOR_VERROU_SCALAR_H
...
#define INTERFLOP_VECTOR_VERROU_API(FCT) interflop_vector_verrou_##FCT##_scalar
