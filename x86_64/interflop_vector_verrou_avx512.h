...
#ifndef __INTERFLOP_VECTOR_VERROU_AVX512_H
#define __INTERFLOP_VECTOR_VERROU_AVX512_H
...
#define INTERFLOP_VECTOR_VERROU_API(FCT) interflop_vector_verrou_##FCT##_avx512
